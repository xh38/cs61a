...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score_0, score_1, last_score = last_score, running_high = running_high):
        if who == 0:
            cur_score = score_0 
        else:
            cur_score = score_1
        this_turn_score = cur_score - last_score
        if this_turn_score > running_high:
            running_high = this_turn_score
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def mean(*args,trial_count = trials_count ):
        total = 0
        turns = 0
        while turns < trial_count:
            total += original_function(*args)
            turns += 1
        average_score = total / trial_count
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(next_score, opponent_score):
    	num = 0
